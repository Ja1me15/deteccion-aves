...
st.markdown(
    """
<style>
/* Fondo: franja verde arriba y azul abajo */
.stApp {
...
/* Panel blanco por cada sección (izquierda / derecha) */
.panel {
...
/* Caption de la imagen (Imagen cargada correctamente) */
...
with col_left:
    ...
    # Título dentro de la tarjeta blanca
    st.markdown(
